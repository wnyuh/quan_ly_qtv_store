...
<form method="POST" class="space-y-4">
    <div class="grid grid-cols-2 gap-4">
        <div>
            <label for="ma_giam_gia" class="block font-medium">Mã giảm giá *</label>
            <input type="text" id="ma_giam_gia" name="ma_giam_gia" required class="input" />
        </div>
        <div>
            <label for="ten" class="block font-medium">Tên *</label>
            <input type="text" id="ten" name="ten" required class="input" />
        </div>
        <div>
        ...
        <div>
            ...
            <input type="number" id="gia_tri_giam" name="gia_tri_giam" min="0" step="0.01" class="input" />
        </div>
        <div>
            <label for="gia_tri_don_hang_toi_thieu" class="block font-medium">Đơn hàng tối thiểu</label>
            <input type="number" id="gia_tri_don_hang_toi_thieu" name="gia_tri_don_hang_toi_thieu" min="0" step="0.01" class="input" />
        </div>
        <div>
            <label for="so_luong_toi_da" class="block font-medium">Số lượng tối đa</label>
            <input type="number" id="so_luong_toi_da" name="so_luong_toi_da" min="1" class="input" />
        </div>
        <div>
        ...
        <div class="col-span-2 flex items-center">
            <input type="checkbox" id="kich_hoat" name="kich_hoat" checked />
            <label for="kich_hoat" class="ml-2">Kích hoạt</label>
        </div>
    </div>
    <div>
        <button type="submit" class="btn w-full">Thêm</button>
    </div>
</form>